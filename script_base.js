...
// ==========================================
// 6. PROGRAM GENERATION (UPDATED WITH PHASES & OVERLOAD & TAPER)
// ==========================================
      ...
      activeLifts.forEach(lift => {
        ...
        // =========================================
            ...
            // Specific Accessories Logic
                ...
                // Taper logic for general accessory
                let accR = [8, 6, 5, 3, 5, 5];
                fSets = (w >= 3) ? 2 : 3; // Drop sets late
                dReps = accR[w];
        ...
        // =========================================
            ...
            // W1 (Index 0): Very Light
            if (w === 0) {
                fSets = 2; dReps = 5; finalIntens = 0.50; 
                weightDisplay = "Recover";
            }
            // W2 (Index 1): Ramp Up (Opposite logic)
            if (w === 1) {
        ...
        // =========================================
            ...
            if (lift.n === "Primer Bench") {
                ...
                // STANDARD TAPER LOGIC FOR COMPOUNDS
